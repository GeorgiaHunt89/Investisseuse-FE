...
import DropZone from '../components/DropZonePitchDeck';
...
import DropZonePitchDeck from '../components/DropZonePitchDeck';
import DropZoneLogo from '../components/DropZoneLogo';
import CategorySelection from '../components/CatergorySelection';
...
function NewBusinessProfile(props) {
  ...
  const [addNewBusiness] = useMutation(ADD_BUSINESS);

  const handleFormSubmit = async (event) => {
    event.preventDefault();
    const mutationResponse = await addNewBusiness({
      variables: { ...formState },
    });
